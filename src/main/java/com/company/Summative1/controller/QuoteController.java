...
public class QuoteController {
    ...
    List<Quote> quotes = List.of(new Quote(1,"George Carlin" , "I went to a bookstore and asked the saleswoman, 'Where's the self-help section?' She said if she told me, it would defeat the purpose."),
            ...
            new Quote(4, "Pandora Poikilos", "The best relationships in our lives are the best not because they have been the happiest ones, they are that way because they have stayed strong through the most tormentful of storms."),
            ...
            new Quote(10, "Sanober Khan", "Even\n" +
